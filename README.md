...
## Notes on NekoBox-style behavior

This wrapper now supports running **TUN + System Proxy together** (`--mode tun-system-proxy`) similar to behavior users expect from NekoBox/Nekoray workflows.
